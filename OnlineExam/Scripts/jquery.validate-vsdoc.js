...
$.extend($.validator, {
	...
	prototype: {
		...
		defaultMessage: function( element, method) {
			return this.findDefined(
				...
				// Exam is never undefined, so handle empty string as undefined
				!this.settings.ignoreExam && element.Exam || undefined,
	...
	normalizeRules: function(rules, element) {
		...
		// To support custom messages in metadata ignore rule methods Examd "messages"
		if (rules.messages) {
